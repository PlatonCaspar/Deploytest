    ...
    if current_user.username is 'Guest':
        return ownNavRenderer.ExtendedNavbar(
            ...
            items=(View('Start', 'start'),
                   Subgroup('Label',
                            View('Print Board Label', 'show_new_label'),
                            View('Print 38mm Label', 'show_new_38mm_label')),
                   Subgroup('New',
                            View('New Board', 'add__board')),
                   View('Projects', 'show_project_all'),
                   View("Parts", 'show_part', ids=None),
                   View("Rooms", "show_all_rooms"),        
                   search_bar
                   ),
        ...
        return ownNavRenderer.ExtendedNavbar(
            ...
            items=(
                    ...
                    Subgroup('New',
                             ...
                             View("New PartType", "create_part_type"),
                             View("New Part", "create_part"),
                             View("New Room", "create_room", room_id=None)),
                    View('Projects', 'show_project_all'),
                    View("Parts", 'show_part', ids=None),                    
                    View("Rooms", "show_all_rooms"),                    
                    Subgroup("Advanced",
